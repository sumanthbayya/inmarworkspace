        ...
        return {
            ...
            link: function(s, r, i, c) {
                var l = c,
                    ...
                    g = i.trimSearch || e.search.trimSearch;
        ...
        return {
            ...
            link: function(r, i, c, l) {
                ...
                var u, p = c.stSort,
                    ...
                    y = "aria-sort";
                i.attr("role", "columnheader").attr(y, "ascending"), c.stSortDefault && (u = r.$eval(c.stSortDefault) !== e ? r.$eval(c.stSortDefault) : c.stSortDefault), i.bind("click", function() {
                    p && r.$apply(o)
                }), u && (d = "reverse" === u ? 1 : 0, o()), r.$watch(function() {
                    return l.tableState().sort
                }, function(t) {
                    t.predicate !== p ? (d = 0, i.removeClass(f).removeClass(m).attr(y, "ascending")) : (d = !0 === t.reverse ? 2 : 1, i.removeClass(h[d % 2]).addClass(h[d - 1]).attr(y, t.reverse ? "ascending" : "descending"))
                }, !0)
            }
        }
